...
namespace IIS.Probasem
{
    ...
    [View("КомнатаE", new string[] {
            "Номер as \'Номер\'",
            "Этаж as \'Этаж\'",
            "КоличетсвоМест as \'Количетсво мест\'"})]
    ...
    public class Комната : ICSSoft.STORMNET.DataObject
    {
        ...
        /// КоличетсвоМест.
        /// </summary>
        // *** Start programmer edit section *** (Комната.КоличетсвоМест CustomAttributes)

        // *** End programmer edit section *** (Комната.КоличетсвоМест CustomAttributes)
        public virtual int КоличетсвоМест
        {
            get
            {
                // *** Start programmer edit section *** (Комната.КоличетсвоМест Get start)

                // *** End programmer edit section *** (Комната.КоличетсвоМест Get start)
                int result = this.fКоличетсвоМест;
                // *** Start programmer edit section *** (Комната.КоличетсвоМест Get end)

                // *** End programmer edit section *** (Комната.КоличетсвоМест Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Комната.КоличетсвоМест Set start)

                // *** End programmer edit section *** (Комната.КоличетсвоМест Set start)
                this.fКоличетсвоМест = value;
                // *** Start programmer edit section *** (Комната.КоличетсвоМест Set end)

                // *** End programmer edit section *** (Комната.КоличетсвоМест Set end)
            }
        }
